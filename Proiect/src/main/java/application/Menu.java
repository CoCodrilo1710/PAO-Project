...
public class Menu {
    ...
    private VerifyAverageThread verificareMedie;
    ...
    public void firstRead() throws IOException {
        ...
        for (int i = 0; i < ii; i++) {
            ...
            parseCommand("Studentul"+ i+ "adaugat");
        ...
        ok = 1;
        parseCommand("Catre Meniu");
        Meniu1(grupa);
    }

    public void Meniu1(Grupa grupaPrincipala) throws IOException {
        ...
        switch (raspuns) {
            ...
            case 2 -> {
                parseCommand("Afisare date despre un anumit student");
            ...
            case 3 -> {
                parseCommand("Adaugare note pentru un student");
                System.out.println("Ati ales sa adaugati note unui anumit student!");
                System.out.println("Introduceti numele studentului: ");
                String nume;
